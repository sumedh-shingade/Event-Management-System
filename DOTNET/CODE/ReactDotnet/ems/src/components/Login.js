...
export default function LoginComponent() {
  ...
  const handleLogin = async (e) => {
    ...
    const loginData = {
      "emailId": email,        //Always use double quotes while using DTO
    ...
    e.preventDefault();
    try {
      const response = await axios.get(`/Logins`, loginData);
      if (response.data) {
        setIsLoggedIn(true);
        ...
        if (loginData.emailId === "4seventmgmtservices@gmail.com") {
    ...
    <div style={containerStyle}>
      <div className="card p-4" style={cardStyle}>
        ...
        {!isLoggedIn && (
          <div className="text-center mt-3">
            <p>
              Don't have an account? <Link to="/Accounts">Register</Link>
            </p>
            <p>
