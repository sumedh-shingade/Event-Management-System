...
const Header = ({ isLoggedIn }) => {
    ...
    const emailId = sessionStorage.getItem('emailId'); // Assuming you retrieve the email from SessionStorage
            ...
            <div className="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <Link to="/Accounts" className="nav-link">Register</Link>
                        </li>
                    ...
                    <Link to={emailId === '4seventmgmtservices@gmail.com' ? "/adminprofile" : "/profile"} className="nav-link">
