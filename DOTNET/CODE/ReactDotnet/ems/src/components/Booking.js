...
function BookingComponent() {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            // const availabilityResponse = await axios.get(`/Bookings/date/${date}/${startTime}/${endTime}`);
            ...
            const bookingData = {
                ...
                "payment": {
                    "status": "Pending",
                    "venueAmt": customVenue.venueCost,
                    "cateringAmt": cat_cost,
                    "mediaAmt": mediaCost,
                    "decorationAmt": decorationCost,
                    "total": totalCost
                },
                "emailId": emailId
